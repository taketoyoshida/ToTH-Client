...
class UserTest {
    ...
    void testBlueprintManagement() {
        ...
        assertEquals(user.getBlueprintQuantity(new Blueprint(EquipmentItem.BRONZE_HELMET)), 3);
        assertEquals(user.getBlueprintQuantity(new Blueprint(EquipmentItem.DIAMOND_DAGGER)), 1);
        assert user.removeBlueprint(new Blueprint(EquipmentItem.BRONZE_HELMET), 1);
        assertEquals(user.getBlueprintQuantity(new Blueprint(EquipmentItem.BRONZE_HELMET)), 2);
        assert user.removeBlueprint(new Blueprint(EquipmentItem.BRONZE_HELMET), 2);
        assertEquals(user.getBlueprintQuantity(new Blueprint(EquipmentItem.BRONZE_HELMET)), 0);
